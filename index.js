...
HardenizeApi.prototype.getSingleSignOnConfig       = endpoint(require('./src/config/getSingleSignOn'));
HardenizeApi.prototype.updateSingleSignOnConfig    = endpoint(require('./src/config/updateSingleSignOn'));
