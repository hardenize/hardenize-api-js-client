...
HardenizeApi.prototype.getAccessControlConfig      = endpoint(require('./src/config/getAccessControl'));
HardenizeApi.prototype.updateAccessControlConfig   = endpoint(require('./src/config/updateAccessControl'));
HardenizeApi.prototype.getNetworkScanningConfig    = endpoint(require('./src/config/getNetworkScanning'));
HardenizeApi.prototype.updateNetworkScanningConfig = endpoint(require('./src/config/updateNetworkScanning'));
HardenizeApi.prototype.getMfaConfig                = endpoint(require('./src/config/getMfa'));
HardenizeApi.prototype.updateMfaConfig             = endpoint(require('./src/config/updateMfa'));
HardenizeApi.prototype.getSamlConfig               = endpoint(require('./src/config/getSaml'));
HardenizeApi.prototype.updateSamlConfig            = endpoint(require('./src/config/updateSaml'));
