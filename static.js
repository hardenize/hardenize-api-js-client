...
module.exports=function(){return this.apiCall({url:"config/singleSignOn"})};
...
module.exports=function(n){return this.apiCall({url:"config/singleSignOn",validStatus:200},{method:"post",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)})};
