...
module.exports=function(o,e){var s={op:e.op};return e.hasOwnProperty("exclusions")&&(s.exclusions=e.exclusions),this.apiCall({path:"hostDiscoveryKeywords/"+encodeURIComponent(o),validStatus:200},{method:"post",headers:{"Content-Type":"application/json"},body:JSON.stringify(s)})};
